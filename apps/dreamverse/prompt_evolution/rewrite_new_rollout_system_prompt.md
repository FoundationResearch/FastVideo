...
==============================================================================
  EVOLVE REGION
  Everything between EVOLVE-BLOCK-START and EVOLVE-BLOCK-END is the MUTABLE
  behavioral policy. OpenEvolve rewrites only this region. The role, inputs,
  context (model mechanics), task contract, and the JSON <output_format> below
  are FROZEN and live outside the block on purpose -- do not move them in.

  NOTE: the evaluator strips the EVOLVE-BLOCK marker lines before sending this
  file to the task model, so these comment markers never leak into the prompt.
==============================================================================
-->
<!-- EVOLVE-BLOCK-START -->
