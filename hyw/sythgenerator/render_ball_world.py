...
class BallWorldState:
    ...
    cam_x: float = 0.0
    cam_y: float = 1.2
    # NOTE: must be within world_bounds_xz (default z range: -2.0 to 3.0)
    cam_z: float = -2.0
    yaw_rad: float = 0.0
    # positive pitch = look DOWN; ~15° centers the ball when cam_z=-2.0
    pitch_rad: float = math.radians(15.0)
