...
from trainer.attention import AttentionMetadata
from trainer.configs.sample.teacache import TeaCacheParams, WanTeaCacheParams
...
class ForwardBatch:
    ...
    """
    # TODO(will): double check that args are separate from trainer_args
...
class TrainingBatch:
    ...
    perspective_embedding: torch.Tensor | None = None
