...
class WanCausalModel(WanModel, CausalModelBase):
    ...
    def predict_noise_streaming(
        ...
        *,
        ...
        # Select text conditioning based on conditional
        # flag.
        if conditional:
        ...
        with torch.autocast(
            ...
            input_kwargs = self._build_distill_input_kwargs(
                noisy_latents, timestep_full, text_dict)
    ...
    def _get_or_init_streaming_caches(
        ...
        *,
        ...
        local_attn_size = (
            self._get_local_attn_size(transformer))
    ...
    def _initialize_kv_cache(
        ...
        *,
        ...
        if num_blocks <= 0:
            raise ValueError(
                "Unexpected transformer.blocks for "
                "causal streaming")
